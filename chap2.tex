...
Figure \ref{fig:mds_topo} illustrates the relationships
...
which are stored as per Figure \ref{fig:mds_topo}(right),
...
adjacencies, i.e. the downward portion of Figure \ref{fig:mds_topo}(right).
...
\begin{figure}
\begin{center}
\includegraphics[width=0.15\textwidth]{adjs_osh.png}
...
pairs of dimensions. Each adjacency is stored in one of the two
formats shown in Figure \ref{fig:osh_up_down}.
\item The structure is created by setting the 
\end{enumerate}
