...
There are many consequences of storing only a subset of entities that
motivate us to avoid that approach in our work:
\begin{enumerate}
...
and storing those entities when queries were made \ref{seol2006efficient}.
Celes, Paulino, and Espinha use a similar solution in their reduced
representation \ref{celes2005compact}.
