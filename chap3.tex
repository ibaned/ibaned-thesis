...
this check on its own can prevent most topological invalidities, except
those in Figure \ref{fig:circle_hole} and Figure \ref{fig:surf_collapse}.
\end{enumerate}

The edge and face ring conditions are more complete versions of those proposed
...
\begin{figure}
\begin{center}
\includegraphics[width=0.45\textwidth]{circle_hole.png}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.3\textwidth]{surf_collapse.png}
