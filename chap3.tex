...
Omega\_h implements similar approaches in order to maintain good element
quality throughout adaptation in both of these cases.
...
all the way to the target mesh and iteratively halves the
...
In the case of displacements, the initial displacement field
is all zero vectors at the vertices.
Linear interpolation between this and the desired displacement
...
{\bf TODO: more background on mesh-to-mesh methods}

\subsection{Conserving Integral Quantities}

{\bf TODO: more background on integral quantity conservation}
